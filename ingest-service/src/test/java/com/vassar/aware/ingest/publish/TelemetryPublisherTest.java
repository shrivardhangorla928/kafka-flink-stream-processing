...
class TelemetryPublisherTest {
    ...
    @Test
    @DisplayName("the counters scrape as aware_ingest_published_total and aware_ingest_publish_failures_total")
    void metricsExposeThePrometheusNamesTheDashboardsUse() {
        ...
        assertThat(scrape).contains("aware_ingest_published_total");

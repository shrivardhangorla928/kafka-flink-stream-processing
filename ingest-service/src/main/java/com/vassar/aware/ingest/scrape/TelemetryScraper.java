package com.vassar.aware.ingest.scrape;

import com.vassar.aware.common.SensorReading;
import com.vassar.aware.ingest.publish.TelemetryPublisher;
import com.vassar.aware.ingest.simulator.ReadingSimulator;
import com.vassar.aware.ingest.station.Station;
import com.vassar.aware.ingest.station.StationRegistry;
 ...
 * whole bean is conditional on {@code aware.ingest.simulator.enabled}, the service can be
 ...
 */
@Component
@ConditionalOnProperty(prefix = "aware.ingest.simulator", name = "enabled", havingValue = "true",
        matchIfMissing = true)
public class TelemetryScraper {
     ...
     */
    @Scheduled(fixedRateString = "${aware.ingest.scrape-interval-ms:60000}")

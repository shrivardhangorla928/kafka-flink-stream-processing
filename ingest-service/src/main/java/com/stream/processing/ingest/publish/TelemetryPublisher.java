...
public class TelemetryPublisher {
     ...
     * {@code stream_ingest_published_total} and {@code stream_ingest_publish_failures_total}.
     * Naming them with underscores here would produce a doubled {@code _total_total} suffix.
     */
    public static final String PUBLISHED_COUNTER = "stream.ingest.published";
    public static final String FAILURES_COUNTER = "stream.ingest.publish.failures";
    public static final String PUBLISH_TIMER = "stream.ingest.publish.duration";

    /** Header carrying why a record was dead-lettered, so the DLQ is triageable without replaying it. */
    public static final String DLQ_REASON_HEADER = "stream-dlq-reason";

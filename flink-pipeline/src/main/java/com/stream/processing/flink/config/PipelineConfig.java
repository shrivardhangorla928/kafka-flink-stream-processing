 ...
 *
 * <p>Resolution order is job argument, then environment variable, then compiled-in default. The
 * environment variable for a parameter is its name upper-cased with dots turned into underscores,
 * so {@code --kafka.bootstrap.servers} reads {@code KAFKA_BOOTSTRAP_SERVERS}.</p>
 */

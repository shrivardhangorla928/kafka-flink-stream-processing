...
import com.vassar.aware.flink.aggregation.ReadingAggregateFunction;
import com.vassar.aware.flink.aggregation.WindowStampingFunction;
import com.vassar.aware.flink.alerting.ThresholdEvaluationFunction;
import com.vassar.aware.flink.config.PipelineConfig;
import com.vassar.aware.flink.ingest.DeadLetterRecord;
import com.vassar.aware.flink.ingest.ParseSensorReadingFunction;
import com.vassar.aware.flink.ingest.ReadingWatermarks;
import com.vassar.aware.flink.ingest.StationIdKeySelector;
import com.vassar.aware.flink.kafka.KafkaConnectors;
...
public final class TelemetryPipelineJob {
    ...
    public static final String JOB_NAME = "aware-telemetry-pipeline";

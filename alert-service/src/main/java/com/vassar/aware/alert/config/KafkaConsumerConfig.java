 ...
 *       listener with the shared {@link com.vassar.aware.common.JsonCodec}. That keeps the wire
...
public class KafkaConsumerConfig {
     ...
     */
    @Bean
    public ConsumerFactory<String, byte[]> awareConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, byte[]> alertListenerContainerFactory(
            ConsumerFactory<String, byte[]> awareConsumerFactory,
            DefaultErrorHandler awareErrorHandler) {
        return batchFactory(awareConsumerFactory, awareErrorHandler);
    }
     ...
     */
    @Bean
    public DefaultErrorHandler awareErrorHandler(KafkaTemplate<String, byte[]> deadLetterKafkaTemplate,

 ...
 * underscores - e.g. {@code aware.alerts.consumed} is scraped as
 * {@code aware_alerts_consumed_total}.</p>
 */
@Component
public class AlertMetrics {

    /** Newly stored alerts. Scraped as {@code aware_alerts_consumed_total}. */
    public static final String CONSUMED = "aware.alerts.consumed";

    /** Replays collapsed by the idempotent upsert. Scraped as {@code aware_alerts_duplicate_total}. */
    public static final String DUPLICATE = "aware.alerts.duplicate";

    /** Batches that failed to persist. Scraped as {@code aware_alerts_persist_failures_total}. */
    public static final String PERSIST_FAILURES = "aware.alerts.persist.failures";

    /** Time to commit one batch. Scraped as {@code aware_alerts_persist_latency_seconds}. */
    public static final String PERSIST_LATENCY = "aware.alerts.persist.latency";

    /**
     * Window close to sink arrival. Scraped as {@code aware_alerts_pipeline_latency_seconds}.
     *
     ...
     */
    public static final String PIPELINE_LATENCY = "aware.alerts.pipeline.latency";

    /** Aggregate rows written by the observability feed. */
    public static final String AGGREGATES_CONSUMED = "aware.aggregates.consumed";

    /** Records routed to the dead-letter topic because they could not be parsed. */
    public static final String DEAD_LETTERED = "aware.alerts.dead.lettered";

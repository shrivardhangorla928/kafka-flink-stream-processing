package com.vassar.aware.alert.web;
...
public class ApiExceptionHandler {
    ...
    private static final URI TYPE_NOT_FOUND = URI.create("urn:aware:alert:not-found");
    private static final URI TYPE_VALIDATION = URI.create("urn:aware:alert:validation-failed");
    private static final URI TYPE_BAD_REQUEST = URI.create("urn:aware:alert:bad-request");
    private static final URI TYPE_INTERNAL = URI.create("urn:aware:alert:internal-error");
